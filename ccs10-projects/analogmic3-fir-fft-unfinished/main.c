...
int16_t data_array1Ping[SAMPLE_LENGTH]; // Mic 1
int16_t data_array1Pong[SAMPLE_LENGTH]; // Mic 1
int16_t data_array2Ping[SAMPLE_LENGTH]; // Mic 2
int16_t data_array2Pong[SAMPLE_LENGTH]; // Mic 2
int16_t data_array3Ping[SAMPLE_LENGTH]; // Mic 3
int16_t data_array3Pong[SAMPLE_LENGTH]; // Mic 3
int16_t data_array4Ping[SAMPLE_LENGTH]; // Mic 4
int16_t data_array4Pong[SAMPLE_LENGTH]; // Mic 4
...
#define NUM_TAPS 26
#define BLOCK_SIZE SAMPLE_LENGTH
...
static q15_t mic1_firStateF32[BLOCK_SIZE + NUM_TAPS -1];
static q15_t mic2_firStateF32[BLOCK_SIZE + NUM_TAPS -1];
static q15_t mic3_firStateF32[BLOCK_SIZE + NUM_TAPS -1];
static q15_t mic4_firStateF32[BLOCK_SIZE + NUM_TAPS -1];
...
int main(void)
{
    ...
    arm_fir_instance_q15 S1;
    arm_fir_instance_q15 S2;
    arm_fir_instance_q15 S3;
    arm_fir_instance_q15 S4;
    arm_fir_init_q15(&S1, NUM_TAPS, firCoeffs32LP, mic1_firStateF32, blockSize);
    arm_fir_init_q15(&S2, NUM_TAPS, firCoeffs32LP, mic2_firStateF32, blockSize);
    arm_fir_init_q15(&S3, NUM_TAPS, firCoeffs32LP, mic3_firStateF32, blockSize);
    arm_fir_init_q15(&S4, NUM_TAPS, firCoeffs32LP, mic4_firStateF32, blockSize);
    ...
    MAP_DMA_setChannelTransfer(UDMA_PRI_SELECT | DMA_CH7_ADC14,
                               ...
                               data_array1Ping, SAMPLE_LENGTH);
    MAP_DMA_setChannelControl(
        UDMA_ALT_SELECT | DMA_CH7_ADC14,
        UDMA_SIZE_16 | UDMA_SRC_INC_NONE | UDMA_DST_INC_16 | UDMA_ARB_1);
    MAP_DMA_setChannelTransfer(UDMA_ALT_SELECT | DMA_CH7_ADC14,
                               UDMA_MODE_PINGPONG, (void*) &ADC14->MEM[0],
                               data_array1Pong, SAMPLE_LENGTH);
    ...
    MAP_DMA_setChannelTransfer(UDMA_PRI_SELECT | DMA_CH7_ADC14,
                               ...
                               data_array2Ping, SAMPLE_LENGTH);
    MAP_DMA_setChannelControl(
        UDMA_ALT_SELECT | DMA_CH7_ADC14,
        UDMA_SIZE_16 | UDMA_SRC_INC_NONE | UDMA_DST_INC_16 | UDMA_ARB_1);
    MAP_DMA_setChannelTransfer(UDMA_ALT_SELECT | DMA_CH7_ADC14,
                               UDMA_MODE_PINGPONG, (void*) &ADC14->MEM[1],
                               data_array2Pong, SAMPLE_LENGTH);
    ...
    MAP_DMA_setChannelTransfer(UDMA_PRI_SELECT | DMA_CH7_ADC14,
                               ...
                               data_array3Ping, SAMPLE_LENGTH);
    MAP_DMA_setChannelControl(
        UDMA_ALT_SELECT | DMA_CH7_ADC14,
        UDMA_SIZE_16 | UDMA_SRC_INC_NONE | UDMA_DST_INC_16 | UDMA_ARB_1);
    MAP_DMA_setChannelTransfer(UDMA_ALT_SELECT | DMA_CH7_ADC14,
                               UDMA_MODE_PINGPONG, (void*) &ADC14->MEM[2],
                               data_array3Pong, SAMPLE_LENGTH);

    MAP_DMA_setChannelControl(
        UDMA_PRI_SELECT | DMA_CH7_ADC14,
        UDMA_SIZE_16 | UDMA_SRC_INC_NONE | UDMA_DST_INC_16 | UDMA_ARB_1);
    MAP_DMA_setChannelTransfer(UDMA_PRI_SELECT | DMA_CH7_ADC14,
                               UDMA_MODE_PINGPONG, (void*) &ADC14->MEM[3],
                               data_array3Ping, SAMPLE_LENGTH);
    MAP_DMA_setChannelControl(
        UDMA_ALT_SELECT | DMA_CH7_ADC14,
        UDMA_SIZE_16 | UDMA_SRC_INC_NONE | UDMA_DST_INC_16 | UDMA_ARB_1);
