...
rectangle('Position',[0 0 env.field], 'LineStyle', line);
axis([-1, env.field(1)+1, -1, env.field(2)+1]);
...
for i = 1:env.num_robots
    ...
    quiver(env.robots(i,1),env.robots(i,2),cos(env.robots(i,3)),sin(env.robots(i,3)),...
