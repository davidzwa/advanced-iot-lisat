...
class serialPlot:
    def __init__(self, serialPort='COM4', serialBaud=38400, plotLength=100, dataNumBytes=2, numPlots=1):
...
def main():
    ...
    # use this instead of plt.show() since we are encapsulating everything in Tkinter
    root.mainloop()
